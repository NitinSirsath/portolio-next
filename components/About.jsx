    ...
    <div id='about' className='w-full md:h-screen p-2 sm:px-10 flex items-center py-16'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            Hello I&apos;m Nitin, I have completing my B.Tech degree in computer science student from MGM-JNEC college in Aurangabad,     Maharashtra. I have always had a knack for
